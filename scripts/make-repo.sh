...
s3cmd --verbose --acl-public --recursive sync /var/packages/repo/rpm/stable s3://repo.onlab.us/rpm/
s3cmd --verbose --acl-public --recursive sync /var/packages/repo/rpm/staging s3://repo.onlab.us/rpm/
s3cmd --verbose --acl-public --recursive sync /var/packages/repo/rpm/unstable s3://repo.onlab.us/rpm/
